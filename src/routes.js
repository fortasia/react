...
const routes = [
  {
    path: '/',
    exact: true,
    component: () => <Redirect to={urlsPath.dashboard.default} />
  },
  {
    path: '/auth',
    ...
    routes: [
      ...
      },
      {
        path: '/auth/map',
        exact: true,
        component: lazy(() => import('components/GoogleMap/GoogleMap'))
      },
      {
        path: '/auth/register',
        exact: true,
  ...
  },
  {
    ...
    routes: [
      {
        path: urlsPath.profile.path,
        exact: true,
        component: lazy(() => import('views/Users/User'))
      },
      {
        path: urlsPath.profile.tabPath,
        exact: true,
        component: lazy(() => import('views/Users/User'))
      },
      {
        path: urlsPath.users.basePath,
        exact: true,
        component: () => <Redirect to={urlsPath.users.listPath} />
      },
      {
        path: urlsPath.users.createPath,
        exact: true,
        component: lazy(() => import('views/Users/CreateUser'))
      },
      {
        path: urlsPath.users.listPath,
        exact: true,
