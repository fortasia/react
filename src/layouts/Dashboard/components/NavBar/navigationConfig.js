...
export default [
  {
    ...
    pages: [
      {
        title: urlsPath.profile.title,
        href: urlsPath.profile.basePath,
        icon: DashboardIcon,
        children: [
          {
            title: 'Update',
            href: urlsPath.profile.updatePath
          },
          {
            title: 'Change Password',
            href: urlsPath.profile.changePasswordPath
          }
        ]
      },
      {
        title: urlsPath.users.title,
        href: urlsPath.users.basePath,
        icon: DashboardIcon,
        children: [
          {
            title: 'Create',
            href: urlsPath.users.createPath
          },
          {
            title: 'List',
            href: urlsPath.users.listPath
          }
        ]
      },
      {
